...
// Create an instance of the Infinario class, which internally generates a 'customerCookie' to identify the anonymous player.
// The 'customerCookie' is a random string generated using the device's hardware and running OS information.
